...
import { Facebook, Instagram, Check, X, Globe, ChevronDown } from "lucide-react";
import {
  Dialog,
  DialogContent,
  DialogTrigger,
...
export const Footer = () => {
  ...
  const translations = {
    ...
    terms: isEnglish ? "General terms and conditions" : "Términos y condiciones generales",
    ...
    version: "v 1.0.0",
    copyright: isEnglish ? "© 2025 Mindly. All rights reserved" : "© 2025 Mindly. Todos los derechos reservados",
      ...
      <div className="w-full mt-14 px-4 md:px-8 lg:px-14 max-md:max-w-full max-w-[1328px] mx-auto">
        <div className="flex w-full gap-[40px_134px] text-sm font-normal flex-wrap max-md:max-w-full">
              ...
              <Drawer open={isLangOpen} onOpenChange={setIsLangOpen}>
                <DrawerTrigger asChild>
                  <button className="flex items-center gap-1 whitespace-nowrap leading-[1.4] mt-8 cursor-pointer hover:text-[#3998E6] transition-colors">
                    ...
                    <span className="self-stretch my-auto">{translations.language}</span>
                  </button>
                </DrawerTrigger>
                <DrawerContent className="h-[30vh]">
                  <div className="px-6 py-4 flex flex-col h-full">
                    <div className="flex justify-between items-center mb-6">
                      <h3 className="text-lg font-semibold">{translations.selectLanguage}</h3>
                      <DrawerClose>
                        <X className="h-5 w-5" />
                      </DrawerClose>
                    </div>
          ...
          <div className="min-w-60 leading-[1.4] grow shrink w-[237px]">
            <h3 className="text-hsl(var(--foreground)) text-[14px] font-dela">{translations.companyHeader}</h3>
          ...
          <div className="min-w-60 text-hsl(var(--foreground)) grow shrink w-[237px] max-md:max-w-full">
            <h3 className="text-hsl(var(--foreground)) text-[14px] font-dela leading-[1.4]">{translations.followUs}</h3>
            ...
            <div className="mt-6">
              <h3 className="text-hsl(var(--foreground)) text-[14px] font-dela leading-[1.4] mb-3">{translations.compliant}</h3>
