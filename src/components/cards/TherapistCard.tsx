        ...
        <div className="flex flex-col items-start justify-center flex-1 min-w-0">
          <div className="flex items-center gap-2 font-semibold text-left flex-wrap">
            <a
              ...
              onClick={(e) => {
                e.preventDefault();
                track(EventName.THERAPIST_NAME_CLICKED, { id: specialist.id });

                setTimeout(() => {
                  window.location.href = specialist.profileUrl;
                }, 300);
              }}
              target="_blank"
            ...
            <img
              src="https://cdn.builder.io/api/v1/image/assets/be084a5d389246af8d6693ab4173d610/c1e8cf4074269db21925479708cd1555a1fdb534?placeholderIfAbsent=true"
              alt="Verified"
              className="aspect-[1] object-contain w-4 shrink-0 max-sm:w-3"
            />
          </div>
          ...
          <div className="flex w-full gap-1 text-[12px] text-[#212121] font-normal flex-wrap mt-[8px] justify-start max-md:text-[12px] max-sm:text-[12px]">
            {specialist.specialties.map((specialty, idx) => (
              <div
                key={idx}
                className="bg-[rgba(33,33,33,0.06)] flex items-center gap-1 justify-center px-2 py-0.5 rounded-full max-md:py-0.5 max-sm:px-1.5 therapist-specialty-tag"
              >
                <img
                  src="https://cdn.builder.io/api/v1/image/assets/be084a5d389246af8d6693ab4173d610/0aaf0b27ba712007b964c4ad960addad3e001d9f?placeholderIfAbsent=true"
                  alt="Badge"
                  className="aspect-[1] object-contain w-3 shrink-0 max-md:w-2.5 max-sm:w-2"
                />
                <div className="text-[12px] whitespace-normal">{specialty}</div>
              </div>
            ))}
          </div>
        </div>
