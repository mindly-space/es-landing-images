...
const CategoryCard = ({
  ...
  return (
    ...
    >
      <div className="overflow-hidden h-full rounded-[32px] flex flex-col" style={{
        backgroundColor: color
      }}>
        <img src={image} alt={title} className="aspect-[1.5] object-cover w-full" />
        <div className="flex w-full flex-col items-start justify-center mt-6 px-6 pb-6 flex-grow">
          ...
          <div className="flex w-full items-center gap-1 text-lg text-white font-semibold text-left mt-2">
            <span className="self-stretch my-auto">{isEnglish ? "Start now" : "Empezar ahora"}</span>
...
export const Categories = () => {
  ...
  const categories = [
    {
      image: "/lovable-uploads/e57d3911-3f49-4e72-8310-eab6acc790de.png?format=webp&quality=80",
      title: isEnglish ? "Stress and burnout" : "Estrés y agotamiento",
      color: "rgba(1,58,89,1)"
    }, 
    {
      image: "/lovable-uploads/a551d4bb-7efb-4590-9e10-9318e93ee9ba.png?format=webp&quality=80",
      title: isEnglish ? "Anxiety" : "Ansiedad",
      color: "rgba(1,76,89,1)"
    }, 
    {
      image: "/lovable-uploads/0d6b42c4-95f2-421d-8f00-affbefce3724.png?format=webp&quality=80",
      title: isEnglish ? "Depression" : "Depresión",
      color: "rgba(1,35,89,1)"
    }, 
    {
      image: "/lovable-uploads/7a7b2fe9-bd44-4d63-ac46-1a586fdb0c09.png?format=webp&quality=80",
      title: isEnglish ? "Loss and grief" : "Pérdida y duelo",
      color: "rgba(4,1,89,1)"
    }, 
    {
      image: "/lovable-uploads/5321d2a3-6b5d-4a6e-b63b-672a9a8da2f5.png?format=webp&quality=80",
      title: isEnglish ? "Relationship issues" : "Problemas de relaciones",
      color: "rgba(84,25,57,1)"
    }, 
    {
      image: "/lovable-uploads/9b8e981c-003a-4b65-bcf5-6e401bf29ae5.png?format=webp&quality=80",
      title: isEnglish ? "Immigration trauma" : "Trauma por migración",
      color: "rgba(44,108,114,1)"
    }
  ];

  return <section className="flex w-full max-w-[1200px] flex-col items-center mx-auto mt-24 max-md:max-w-full max-md:mt-10 px-0 my-[95px]">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-[51px] w-full max-md:mt-10">
        {categories.map((category, index) => <div key={index} className="h-full">
