...
export const ComparisonTable = () => {
  ...
  const checkIcon = "/lovable-uploads/f7d3ac08-f688-45c0-991c-1c3fea63bbf8.png?format=webp&quality=100";
  const cancelIcon = "/lovable-uploads/fd254329-105f-41cd-80e1-c8d1162c72ed.png?format=webp&quality=100";
  const helpIcon = "/lovable-uploads/afa571b1-94c4-4abc-80e7-cee25923f9cc.png?format=webp&quality=100";
  const mindlyLogo = "/lovable-uploads/e037b47e-3d80-42f5-b64c-e6da0eaafa0e.png?format=webp&quality=100";
  const newMobileHeaderLogo = "/lovable-uploads/803272b9-480d-47ca-9270-b9e818a92413.png?format=webp&quality=100";
  const userProvidedLogo = "/lovable-uploads/15bcbe57-9a51-4626-8e19-4d4466370f02.png?format=webp&quality=100";
