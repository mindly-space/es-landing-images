      ...
      <div className={`flex flex-col ${isMobile ? 'flex-col-reverse' : 'lg:flex-row'} items-center gap-10 lg:gap-20`}>
        ...
        once: true
          ...
          <div className="relative map-container">
            <img src="https://raw.githubusercontent.com/mindly-space/es-landing-images/b89ee670371004da3cf0d4f7328303619f9df2a4/images/map.svg" alt="World map showing Mindly's global presence" className="w-full h-auto" />
          </div>
        </motion.div>
      </div>
    </section>;
