      ...
      once: true
        ...
        <div className="w-full flex flex-col md:flex-row items-center gap-8 md:gap-[80px] mb-8">
          <div className="md:w-1/2">
            <img src="https://cdn.builder.io/api/v1/image/assets%2Fbe084a5d389246af8d6693ab4173d610%2F508ce0e802a54c94ba4e27b70a3e66cb?format=webp&quality=80" alt={`${isEnglish ? "Online therapy" : "Terapeuta en línea"}`} className="w-full rounded-lg" />
          </div>
