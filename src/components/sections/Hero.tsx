...
export const Hero = () => {
  ...
  return (
    <motion.section 
      ...
      className={`bg-[rgba(1,58,89,1)] w-full p-10 rounded-[32px] max-md:p-6 max-md:max-w-full max-md:h-auto xl:max-w-none flex items-center my-10 ${isMobile ? 'min-h-fit' : 'max-h-[80vh]'} overflow-hidden`}
    >
      <div className={`gap-5 flex ${isMobile ? 'flex-col' : ''} items-stretch max-md:w-full w-full max-w-[1328px] mx-auto xl:max-w-none xl:px-0 xl:justify-between`}>
        {isMobile && (
          <div className="w-full flex justify-center gap-4 scale-[0.9] mb-6">
            ...
            >
              <AspectRatio ratio={1/1} className="w-full h-full">
                <img
                  src="/lovable-uploads/eeb9c4de-f1c3-4e97-8def-2fe71e0fdbcb.png"
                  alt="Therapy Session"
            ...
            >
              <AspectRatio ratio={1/1} className="w-full h-full">
                <img
                  src="/lovable-uploads/626e31d2-1ef1-4f2b-959e-377dff7006b8.png"
        ...
        <motion.div variants={itemVariants} className={`${isMobile ? 'w-full' : 'w-[53%]'} flex items-center justify-center xl:max-w-[650px] xl:w-auto xl:flex-1 xl:mx-auto`}>
          <div className="flex w-full flex-col self-stretch items-center justify-center my-auto text-center">
            ...
            <a href={ctaLink}>
              <Button 
                variant="mindly"
                size="mindly" 
                className={`text-base text-white font-semibold hover:bg-[#1989d2] transition-colors max-md:px-5 ${isMobile ? 'my-6' : 'mt-8'}`}
              >
          ...
          >
            <div className="w-full max-w-[320px] flex items-center justify-center">
              ...
              >
                <AspectRatio ratio={1/1} className="w-full">
                  <img
                    src="/lovable-uploads/a1f95cda-ce0c-4d17-ae23-84d920a8f74a.png"
                    alt="Happy family moment"
                    className="object-contain w-full h-full"
                  />
                </AspectRatio>
            ...
            <div className="w-full max-w-[320px] flex items-center justify-center">
              ...
              >
                <AspectRatio ratio={1/1} className="w-full">
                  <img
                    src="/lovable-uploads/3f2f4a07-f04f-4bf9-8e3f-71523bdbb181.png"
                    alt="Happy family with dog"
                    className="object-contain w-full h-full"
                  />
                </AspectRatio>
